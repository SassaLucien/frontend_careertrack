      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {loadingCompanies ? (
          ...
          <InfoSection icon="business-outline" title="Entreprises ayant accepté la candidature">
            {companiesWithEvaluations.map((comp) => (
              <View key={comp.companyId} style={styles.companyCard}>
                ...
                {comp.applications && comp.applications.some(app => app.behaviorRating || app.skillsRating) && (
                  <View style={styles.evalSummaryBlock}>
                    <Text style={styles.evalSummaryTitle}>Évaluations</Text>
                    {comp.applications.map((app, appIdx) => {
                      const hasEvaluation = app.behaviorRating || app.skillsRating;
                      if (!hasEvaluation) return null;
                      return (
                        <View key={appIdx} style={styles.evalPillsRow}>
